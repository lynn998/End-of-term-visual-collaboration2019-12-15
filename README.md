# ✍🏻✍🏻✍🏻揭深广佛的社会经济现象探索性研究✍🏻✍🏻✍🏻 
#### pythonanywhere(由于部署报错，仅展示部分页面) :liuweihao.pythonanywhere.com
#### 完整页面请下载源码包：
#### 或浏览在线截屏：
### 一、研究特征：
...
*   [x] 交互功能对于强化数据产品或者数据故事表现力的程度（已完成）

*   [x] 交互界面是否美观、得体（用plotly、pyecharts、网页CSS样式等渠道实现的都包含在内）（已完成）
